    ...
    <svg viewBox="0 0 64 64" className={className} aria-hidden="true">
      <defs>
        <linearGradient id="logo-brand" x1="0" y1="0" x2="1" y2="1">
          ...
          <stop offset="1" stopColor="#054239" />
        </linearGradient>
      </defs>
      <rect width="64" height="64" rx="15" fill="url(#logo-brand)" />
      <path
  ...
  return (
    <span className={cn('flex items-center gap-2.5', className)}>
      ...
      <span className="leading-tight">
        ...
        {showTagline && (
          <span className={cn('block text-[10px] font-medium', inverse ? 'text-white/80' : 'text-muted')}>
