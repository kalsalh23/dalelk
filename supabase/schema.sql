...
-- ---------- حسابات الجهات (لوحة تحكم خاصة بالطبيب/العيادة/…) ----------
...
-- =====================================================
-- دوال حسابات الجهات (لوحة تحكم خاصة بكل جهة)
-- =====================================================

-- إنشاء حساب جهة (لكل طبيب/عيادة/مخبر… يُسلَّم للطبيب رابط + بريد + كلمة سر عند التفعيل)
...
-- دخول الجهة بالبريد وكلمة السر → يردّ جلسة مؤقتة
